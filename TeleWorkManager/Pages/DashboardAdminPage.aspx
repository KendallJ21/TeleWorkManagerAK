...
<head runat="server">
    ...
    <link href="../CSS/DashboardAdminPage.css"
        rel="stylesheet" />
    ...
    <form id="form2" runat="server">
        ...
        <div class="container py-4">
            ...
            <div class="text-center mb-4">
                ...
                <h4 class="text-muted">Administración del sistema
                </h4>

                <div class="mt-3">

                    <a href="DashboardEmployeePage.aspx"
            ...
            <div class="col-12">
                ...
                <div class="policy-card">
                    ...
                    <div class="w-100">
                        ...
                        <h5>Reglas especiales por departamento
                        </h5>
            ...
            cada departamento.
                        ...
                        Seleccione un departamento
                            ...
                            <div class="col-md-2 d-flex align-items-end">
                                ...
                                <asp:Button
                                    ID="btnGuardarPoliticaDepartamento"
                                    runat="server"
                                    Text="Guardar"
                                    CssClass="btn btn-custom w-100" />
                    ...
                    <div class="policy-card">
                        ...
                        <div>
                            ...
                            <div class="input-group">
                                ...
                                <span class="input-group-text">días
                                </span>
            ...
            <div class="admin-table-card">
                ...
                <div class="d-flex justify-content-between
                    ...
                    <div>
                        ...
                        <h5 class="mb-1">Empleados registrados
                        </h5>

                        <small class="text-muted">Administre los usuarios del sistema.
                        </small>
